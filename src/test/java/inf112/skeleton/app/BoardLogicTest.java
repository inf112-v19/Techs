...
public class BoardLogicTest {
    ...
    public void addPlayerToBoard() {
        noWallBoard.addPlayerToBoard(new Vector2(0,0), new Vector2(2, 4), "newPlayer");
        assertEquals(new Vector2(0,0), noWallBoard.getPlayerLocation("newPlayer"));
    }
    
    @Test
    public void movePlayerTest() {
        noWallBoard.addPlayerToBoard(new Vector2(1,1), new Vector2(2, 4), "PlayerOne");
    ...
    public void wallCollisionTest() {
        wallBoard.addPlayerToBoard(new Vector2(1,1), new Vector2(2, 4), "PlayerOne");
