...
public class LaserTests {
    ...
    public void OneDamageTokenReceivedAfterOneLaserShot() {
        board.addPlayerToBoard(new Vector2(1, 0), new Vector2(2, 4), "Player", false);
    ...
    public void PlayerOnTileWhereLaserShootsGetsDamage() {
        board.addPlayerToBoard(new Vector2(0,0), new Vector2(2, 4), "Player", false);
        board.activateLasersOnBoard();
        assertEquals(1, board.getPlayerByName("Player").getDamageToken());
    }
    ...
    public void OnlyOnePlayerGetsDamageOnSameLaserAxisFromBoardLaser() {
        board.addPlayerToBoard(new Vector2(1,0), new Vector2(2, 4), "PlayerOne", false);
        board.addPlayerToBoard(new Vector2(2,0), new Vector2(2, 4), "PlayerTwo", false);
        board.activateLasersOnBoard();
    ...
    public void BothPlayersLoseDamageIfShootingAtEachother() {
        board.addPlayerToBoard(new Vector2(0, 1), new Vector2(2, 4), "PlayerOne", false);
        board.addPlayerToBoard(new Vector2(2, 1), new Vector2(2, 4), "PlayerTwo", false);
    ...
    public void ReceivesTwoDamageIfShotByLaserAndPlayer() {
        board.addPlayerToBoard(new Vector2(0, 2), new Vector2(2, 4), "PlayerOne", false);
        board.addPlayerToBoard(new Vector2(0, 1), new Vector2(2, 4), "PlayerTwo", false);
        board.shootPlayerLaser();
        board.activateLasersOnBoard();
    ...
    public void TwoPlayerShootingEachotherOnLaserOnBoardAxis() {
        board.addPlayerToBoard(new Vector2(0, 0), new Vector2(2, 4), "PlayerOne", false);
        board.addPlayerToBoard(new Vector2(2, 0), new Vector2(2, 4), "PlayerTwo", false);
        board.rotatePlayer("PlayerOne", 1);
        board.rotatePlayer("PlayerTwo", -1);
        board.shootPlayerLaser();
