...
public class MoveConveyorBeltsTests {
    ...
    public void playerMovesLeft() {
        circleBoard.addPlayerToBoard(new Vector2(1, 2), new Vector2(2, 4), "testPlayerOne");
        circleBoard.moveConveyorBelts();
        assertEquals(new Vector2(0, 2), circleBoard.getPlayerLocation("testPlayerOne"));
    }
    @Test
    public void playerMovesRight() {
        circleBoard.addPlayerToBoard(new Vector2(1, 0), new Vector2(2, 4), "testPlayerOne");
        circleBoard.moveConveyorBelts();
        assertEquals(new Vector2(2, 0), circleBoard.getPlayerLocation("testPlayerOne"));
    }
    @Test
    public void playerMovesDown() {
        circleBoard.addPlayerToBoard(new Vector2(0, 1), new Vector2(2, 4), "testPlayerOne");
        circleBoard.moveConveyorBelts();
        assertEquals(new Vector2(0, 0), circleBoard.getPlayerLocation("testPlayerOne"));
    }
    @Test
    public void playerMovesUp() {
        circleBoard.addPlayerToBoard(new Vector2(2, 1), new Vector2(2, 4), "testPlayerOne");
        circleBoard.moveConveyorBelts();
    ...
    public void playerRotatesRightUpperLeftCorner() {
        circleBoardRight.addPlayerToBoard(new Vector2(0, 1), new Vector2(2, 4), "testPlayerOne");
    ...
    public void playerRotatesRightBottomLeftCorner() {
        circleBoardRight.addPlayerToBoard(new Vector2(1, 0), new Vector2(2, 4), "testPlayerOne");
        circleBoardRight.moveConveyorBelts();
        assertEquals(Direction.EAST, circleBoardRight.getPlayerRotation("testPlayerOne"));
    }
    @Test
    public void playerRotatesRightBottomRightCorner() {
        circleBoardRight.addPlayerToBoard(new Vector2(2, 1), new Vector2(2, 4), "testPlayerOne");
        circleBoardRight.moveConveyorBelts();
        assertEquals(Direction.EAST, circleBoardRight.getPlayerRotation("testPlayerOne"));
    }
    @Test
    public void playerRotatesRightUpperRightCorner() {
        circleBoardRight.addPlayerToBoard(new Vector2(1, 2), new Vector2(2, 4), "testPlayerOne");
        circleBoardRight.moveConveyorBelts();
        assertEquals(Direction.EAST, circleBoardRight.getPlayerRotation("testPlayerOne"));
    }
    @Test
    public void twoPlayersStraightForward() {
        circleBoard.addPlayerToBoard(new Vector2(0,0), new Vector2(2, 4), "testPlayerOne");
        circleBoard.addPlayerToBoard(new Vector2(1,0), new Vector2(2, 4), "testPlayerTwo");
        circleBoard.moveConveyorBelts();
    ...
    public void twoPlayersOneGetsMovedUp() {
        circleBoard.addPlayerToBoard(new Vector2(1,0), new Vector2(2, 4), "testPlayerOne");
        circleBoard.addPlayerToBoard(new Vector2(2,0), new Vector2(2, 4), "testPlayerTwo");
        circleBoard.moveConveyorBelts();
        assertEquals(new Vector2(2,0), circleBoard.getPlayerLocation("testPlayerOne"));
    ...
    public void threePlayersInALine() {
        circleBoard.addPlayerToBoard(new Vector2(0,0), new Vector2(2, 4), "testPlayerOne");
        circleBoard.addPlayerToBoard(new Vector2(1,0), new Vector2(2, 4), "testPlayerTwo");
        circleBoard.addPlayerToBoard(new Vector2(2,0), new Vector2(2, 4), "testPlayerThree");
        circleBoard.moveConveyorBelts();
        assertEquals(new Vector2(1,0), circleBoard.getPlayerLocation("testPlayerOne"));
        assertEquals(new Vector2(2,0), circleBoard.getPlayerLocation("testPlayerTwo"));
    ...
    public void doubleConveyorBeltOnePlayerMoves() {
        circleBoardDouble.addPlayerToBoard(new Vector2(1, 2), new Vector2(2, 4), "testPlayerOne");
    ...
    public void doubleConveyorBeltTwoPlayerMove() {
        circleBoardDouble.addPlayerToBoard(new Vector2(1, 2), new Vector2(2, 4), "testPlayerOne");
        circleBoardDouble.addPlayerToBoard(new Vector2(2, 2), new Vector2(2, 4), "testPlayerTwo");
        circleBoardDouble.moveConveyorBelts();
        assertEquals(new Vector2(0, 1), circleBoardDouble.getPlayerLocation("testPlayerOne"));
    ...
    public void doubleMovesFirst() {
        doubleMovesFirstBoard.addPlayerToBoard(new Vector2(1,0), new Vector2(2, 4), "testPlayerOne");
        doubleMovesFirstBoard.addPlayerToBoard(new Vector2(2,1), new Vector2(2, 4), "testPlayerTwo");
