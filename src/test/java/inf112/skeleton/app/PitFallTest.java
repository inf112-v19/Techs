...
public class PitFallTest {
    ...
    public void movePlayerToStartpositionAfterPitFall() {
    	board.addPlayerToBoard(new Vector2(1, 4), new Vector2(2, 18), "Player"); //StartPosition (1, 4)
    ...
    public void movePlayerToCheckpointAfterPitFall() {
    	...
    	board.addPlayerToBoard(startPos, new Vector2(2, 18), "Player");
    ...
    public void checkIfTwoPlayersCanMoveToSameBackup() {
    	board.addPlayerToBoard(new Vector2(1, 4), new Vector2(2, 18), "Player1");
    	board.addPlayerToBoard(new Vector2(1, 4), new Vector2(2, 18), "Player2");
    ...
    public void moveToBackupIfOutOfBoardTest() {
    	board.addPlayerToBoard(new Vector2(2,2), new Vector2(2, 18), "Player");
